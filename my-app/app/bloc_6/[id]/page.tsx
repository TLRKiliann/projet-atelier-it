...
export default function CategoriePage_6() {
  ...
  const fetchCategorie = async (): Promise<void> => {
    try {
      const response = await fetch('/api/inventory?blocId=bloc_6');
    ...
    return (
      <div className={styles.page_bloc}>
        <div className={styles.titleAndBtn}>
          <button onClick={() => router.push("/bloc_6")} className={styles.btn_return}>
            <FaArrowLeft size={32} />
          </button>
