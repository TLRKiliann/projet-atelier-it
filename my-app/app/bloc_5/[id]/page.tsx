...
export default function CategoriePage_5() {
  ...
  const fetchCategorie = async (): Promise<void> => {
    try {
      const response = await fetch('/api/inventory?blocId=bloc_5');
    ...
    return (
      <div className={styles.page_bloc}>
        <div className={styles.titleAndBtn}>
          <button onClick={() => router.push("/bloc_5")} className={styles.btn_return}>
            <FaArrowLeft size={32} />
          </button>
